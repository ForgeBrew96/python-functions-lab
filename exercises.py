...
def apply_discount(price, discount):
    if 0 <= discount <= 100:
        ...
        sale_price = price - discounted_amount
        return sale_price
    else:
        print(f'The discount {discount} is not between 0 and 100')
...
def convert_temperature(temp, unit):
    if unit == 'C':
        temp_type_change = (temp * 9/5) + 32
    elif unit == 'F':
        temp_type_change = (temp - 32) * 5/9

    return temp_type_change
